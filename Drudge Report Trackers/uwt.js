twttr = window.twttr || {}, twttr.conversion = function() {
    ...
    var n = "//t.co/i/adsct?type=javascript&version=1.1.0&p_id=Twitter&p_user_id=0",
        i = "https://analytics.twitter.com/i/adsct?type=javascript&version=1.1.0&p_id=Twitter&p_user_id=0",
        r = function(e, t) {
            var n = t.toLowerCase();
            for (var i in e)
        ...
        function() {
            ...
            trackPidBase: function(e, t, n, i) {
                if (t) {
                    ...
                    i && (a += "&tpx_cb=twttr.conversion.loadPixels", u = this.buildScript);
                    a += "&tw_document_href=" + encodeURIComponent(document.location.href);
            ...
            getIframeStatus: function() {
                try {
                    return this.isIframed() ? this.IframeStatusCodes.IN_IFRAME : this.IframeStatusCodes.NOT_IN_IFRAME
                } catch (e) {
