! function(e) {
    ...
    var c = new(function() {
            ...
            return t = e, (n = [{
                ...
                value: function(e, t) {
                    var n = "";
                    return e && (n = Object.keys(e).reduce(function(n, a) {
                        return n.push([a, e[a]].join(t)), n
                    }, []).join("&")), n
                }
            }, {
                key: "getQueryParamByName",
                value: function(e) {
                    var t, n, a, r, o = i.location.search && i.location.search.toLowerCase(),
                        s = o && o.indexOf(e);
                    return -1 !== s && (t = o.indexOf("=", s) + 1, n = -1 === (a = o.indexOf("&", t)) ? void 0 : a, r = decodeURIComponent(o.slice(t, n))), r
                }
            }, {
                key: "diagPix",
                value: function(e, t) {
                    ...
                    if (!i.diagPixSentCodes[e]) try {
                        n = this.getAnid(), a = this.getSessionId(), i.diagPixSentCodes[e] = !0, r = {
                            code: "pet_" + e,
                            anid: n,
                            sessionId: a
                        }, t && (r.err = encodeURIComponent(t.message)), o = this.buildQueryString(r, ":"), (new i.Image).src = "//pixel.adsafeprotected.com/jsdiagnostic?" + o
                    } catch (e) {
                        c.error(e)
                    }
                }
                ...
                value: function(e, t) {
                    var n = "background-color: ",
                        a = i.console && "function" == typeof i.console.error,
                        r = this.getQueryParamByName("iasdebug"),
                        o = r && "TRUE" === r.toUpperCase();
                    "log" === e ? n += "lightgreen" : "error" === e ? n += "pink" : "warn" === e && (n += "lightyellow"), a && o && console.log("%cIAS_DEBUG: " + t, n)
                }
    ...
    var b = new(function() {
            ...
            return t = e, (n = [{
                ...
                value: function(e, t, n, a) {
                    var r, i;
                    try {
                        (r = new XMLHttpRequest) && (i = encodeURI(e + "?" + t), r.open("GET", i), r.onreadystatechange = function() {
                            var e;
                            if (4 === r.readyState && 200 === r.status)
                                if ((e = r.responseText).code) c.error("XMLHttpRequest failure code: " + e.code + ", message: " + e.message);
                                else if (n) try {
                                n.call({}, e || {})
                            } catch (e) {
                                c.error("Error firing the XMLHttpRequest callback: " + e.message)
                            }
                        }, a && (r.timeout = a), r.ontimeout = function() {
        ...
        _ = function(e) {
            var t, n, a, r, i, o, s, u, c = {},
                l = function(e) {
                    return e && e.replace(/[^\w-_.>\/]/g, "")
                };
            t = l((i = e.adSlotId) && i.replace(/\//g, "")), n = e.size && e.size instanceof Array && e.size.join("."), a = l(e.adUnitPath), r = function(t) {
                var n = "display";
                ...
                return e.join(".")
            }).join(","), u.ss = "[" + s + "]") : u.s = o.join(".")), u))).p = a, c.t = r;
            return {
                toString: function() {
                    var e, t = [];
    ...
    var A = new(function() {
        function e() {
            ...
            ! function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, e), a = [], (n = "list") in (t = this) ? Object.defineProperty(t, n, {
                value: a,
                enumerable: !0,
                configurable: !0,
                writable: !0
        ...
        return t = e, (n = [{
            ...
            value: function(e) {
                var t = JSON.parse(e),
                    ...
                    a = t[this.SLOTS_OBJECT_FIELD_NAME],
                    r = t[this.CUSTOM_FIELD_NAME];
                ...
                i(n, this.cachedPageData), i(a, this.cachedSlotsData), i(r, this.cachedCustomData)
            }
        }, {
            key: "clearCaches",
            value: function() {
    ...
    var C = function() {
        function e() {
            ...
            ! function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, e), a = {}, (n = "requestStatusDict") in (t = this) ? Object.defineProperty(t, n, {
                value: a,
                enumerable: !0,
                configurable: !0,
                writable: !0
        ...
        return t = e, (n = [{
            ...
            value: function(e) {
                var t, n, a = this,
                    r = c.getQueryParamByName("iasprofileprobability") || 10,
                    i = {};
                b.chance(r) && setTimeout(function() {
                    t = a.requestStatusDict[e], n = t && t - e, i.responsetime = n, i.probability = r, c.diagPix(h, {
            ...
            value: function(e, t) {
                var n, a, r, i = this,
                    ...
                    l = b.isFn(e);
                u && (n = function(t) {
                    o = b.now(), c.log("PET response " + t), i.requestStatusDict[a] = o, D.updateData(t), x.updateData(t), l && e(t), clearTimeout(r)
                }, a = b.now(), this.requestStatusDict[a] = !1, b.sendXHR(s, u, n, t), r = this.reportLongRequest(a), this.reportResponseTime(a), A.clear())
            }
        }, {
            key: "stringifySize",
            value: function(e) {
            ...
            value: function() {
                var e = [],
                    t = i.__iasPET.pubId,
                    n = this.stringifySize(a(i)),
                    o = this.stringifySize(r(i)),
                    s = i.__iasPET.sessionId,
                    u = i.__iasPET.effectiveURL;
                if (!A.isEmpty() && t) return e.push("anId=" + t), e.push(A.stringify()), e.push("wr=" + n), e.push("sr=" + o), e.push("sessionId=" + s), e.push("url=" + encodeURIComponent(u)), c.log("ad slots set: " + JSON.stringify(A)), c.log("anid set: " + t), e.join("&");
    ...
    var U = function() {
        ...
        function a() {
            ! function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, a), F(this, "adServer", void 0), F(this, "iframesHtmlContents", {}), F(this, "topRequests", [{
                id: "isRefreshable",
                ...
                handler: function(e, t, n) {
                    try {
                        var a = e.getAdServer(),
                            r = a.getAllAdSlots();
                        a.findAdSlotByAdUnitId(r, n.adUnitId, function(a, r) {
                            !a && r ? e.recordAdSlotImpression(t, n.asid, n.adUnitId, r, n.cacheId) : c.warn("Unable to find adSlot by adUnitId", a)
                ...
                handler: function(e, t, n) {
                    try {
                        var a = e.getAdServer(),
                            r = n && n.adUnitId;
                        a.refresh(a.findAdSlotByCacheId(n.cacheId), r)
                    } catch (e) {
                        c.error(e)
                    }
                }
                ...
                isAdUnitIdInSlot: function(e, t, n) {
                    var a = null,
                        r = new RegExp("&chanId=".concat(t, "&"), "g"),
                ...
                updateUnsafeAdSlots: function(e, t) {
                    ...
                    return e.forEach(function(e) {
                        var a = ["google_ads_iframe_".concat(e.getSlotId().toString()), "google_ads_iframe".concat(e.getSlotId().toString())].filter(function(e) {
                                return Boolean(i.document.getElementById(e)) && !t.hasOwnProperty(e)
                            })[0],
                            r = i.document.getElementById(a) || null;
                        if (r) try {
                            var o = r.contentDocument || r.contentWindow && r.contentWindow.document;
                            o && Object.defineProperty(n, a, {
                ...
                matchAdSlotHtml: function(e, t) {
                    if (!e) return null;
                    var n, a, r, i = this.updateUnsafeAdSlots(e, t),
                        o = Object.keys(i).map(function(e) {
                            return i[e]
                        });
                    return e.forEach(function(e) {
                        n = e.getEscapedQemQueryId(), r = new RegExp("".concat(n), "g"), e.iasHtml = o.filter(function(e) {
                            return r.test(e)
                        })[0] || null, e.iasHtml || (a = new RegExp("".concat(e.getSlotId().toString()), "g"), Object.keys(i).forEach(function(t) {
                            a.test(t) && (e.iasHtml = i[t])
                        }))
                    }), e
                },
                findAdSlotByAdUnitId: function(e, t, n, a, r) {
                    var i = this.matchAdSlotHtml(e, a);
                    if (i && Array.isArray(i)) {
                        var o, s = null;
                        for (o = 0; o < i.length; o += 1)
                            if (s = this.isAdUnitIdInSlot(i[o], t, r)) {
                                n(null, s);
                                break
                            }
                ...
                refresh: function(e, t) {
                    var n = i.googletag && i.googletag.cmd,
                        a = i.googletag && i.googletag.pubads && "function" == typeof i.googletag.pubads && i.googletag.pubads();
                    n && a && "function" == typeof a.refresh && e && !this.isAdSlotExcluded(e, t) && (this.setRefreshTargeting(e, t), n.push(function() {
                        a.refresh([e])
                    }))
                },
                ...
                buildAndValidateExtras: function(e, t, n) {
                    ...
                    if ("adSize" === e) {
                        ...
                        a = new RegExp("(".concat(r.join("|"), ")"), "g").test(n)
                    }
                    if (/^custom/.test(e)) {
                        var i = t.map(function(t) {
                            return "&".concat(e, "=").concat(t)
                        });
                        a = new RegExp("(".concat(i.join("|"), ")"), "g").test(n)
                    }
                    return a
                },
                isAdSlotExcluded: function(e, t) {
                    var n = this,
                        a = e.getResponseInformation(),
                        r = i.__iasAdRefreshConfig.excludeList ? JSON.parse(JSON.stringify(i.__iasAdRefreshConfig.excludeList)) : null,
                        o = !1;
                    return a.adUnitId = NaN !== Number(t) ? Number(t) : t, a.chanId = a.adUnitId, r && Object.keys(r).forEach(function(t) {
                        Array.isArray(r[t]) || "object" === L(r[t]) || (r[t] = [r[t]]), a.hasOwnProperty(t) && r[t].indexOf(a[t]) > -1 && (o = !0), ("adSize" === t || /^custom/.test(t)) && (o = n.buildAndValidateExtras(t, r[t], e.iasHtml))
                    }), o
                }
            }]);
            var e = this;
        ...
        return e = a, (t = [{
            ...
            value: function(e, t, n, a, r) {
                try {
                    var i = "".concat(this.getAdSlotDataIdForAdUnitId(n), "__").concat(a.getSlotId().toString());
                    a.cacheId = r, o.__IntegralASExec = o.__IntegralASExec || {}, o.__IntegralASExec.adSlotData = o.__IntegralASExec.adSlotData || {}, o.__IntegralASExec.adSlotData.hasOwnProperty(i) ? o.__IntegralASExec.adSlotData[i].refreshCount += 1 : o.__IntegralASExec.adSlotData[i] = {
                        refreshCount: 0,
                        refreshSessionId: t,
                        adSlot: a
    ...
    var M = function e() {
        if (function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, e), i.__iasPET.queue = i.__iasPET.queue || [], i.__iasPET.VERSION = "1.16.18", i.__iasPET.setTargetingForGPT = D.setTargeting(), i.__iasPET.setTargetingForAppNexus = x.setTargeting(), "undefined" != typeof XMLHttpRequest) {
            i.__iasPET.sessionId = b.getUID(), window.context && window.context.domFingerprint.match(/amp/g) ? i.__iasPET.effectiveURL = i.__iasPET.effectiveURL || i.document.referrer : i.__iasPET.effectiveURL = i.__iasPET.effectiveURL || i.location.href, (new N).executeCommands();
            new U
        } else c.diagPix(g)
    };
